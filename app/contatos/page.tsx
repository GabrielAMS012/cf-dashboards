      ...
      <div className="p-6">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">Gestão de contatos do sistema</p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Sistema de gestão de contatos em desenvolvimento</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 max-w-md mx-auto">
                A funcionalidade de gestão de contatos está sendo desenvolvida.
              </p>
            </div>
          </CardContent>
        </Card>
